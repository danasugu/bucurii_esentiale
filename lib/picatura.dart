...
class PicaturaPosts extends StatefulWidget {
  @override
  _PicaturaPostsState createState() => _PicaturaPostsState();
}

class _PicaturaPostsState extends State<PicaturaPosts> {
  ...
  Future<String> getPosts() async {
    var res = await http.get(
        Uri.encodeFull(apiUrl + "posts?categories=321&_embed"),
