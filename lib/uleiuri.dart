...
class UleiuriPosts extends StatefulWidget {
  @override
  _UleiuriPostsState createState() => _UleiuriPostsState();
}

class _UleiuriPostsState extends State<UleiuriPosts> {
  ...
  Future<String> getPosts() async {
    var res = await http.get(
        Uri.encodeFull(apiUrl + "posts?categories=35&_embed"),
