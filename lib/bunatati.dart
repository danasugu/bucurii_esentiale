...
class BunatatiPosts extends StatefulWidget {
  @override
  _BunatatiPostsState createState() => _BunatatiPostsState();
}

class _BunatatiPostsState extends State<BunatatiPosts> {
  ...
  Future<String> getPosts() async {
    var res = await http.get(
        Uri.encodeFull(apiUrl + "posts?categories=320&_embed"),
